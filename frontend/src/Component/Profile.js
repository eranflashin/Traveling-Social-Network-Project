...
export default class UserProfile extends Component {
    ...
    render() {
        ...
        const edit_user_form = (
            <Modal show={this.state.show_edit} onHide={this.handleCloseEdit.bind(this)}>
        ...
        const curr_user_details = (
            <>
                ...
                <div className="text-light">{this.state.email}</div>
                {edit_user_form}
                <Button variant="primary" onClick={this.handleOpenEdit.bind(this)}>
                    Edit
                </Button>
            </>
        );
                ...
                <div className="profile-block">
                    ...
                    {this.state.is_following ?
                        (this.state.curr_user_id == this.state.id ?
                                curr_user_details : user_details
                        ) : follow_button}
                </div>
            </>
        );
